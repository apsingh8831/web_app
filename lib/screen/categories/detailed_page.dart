            ...
            Expanded(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => ContactSeller()));
              },
              text: "Chat",
            )
                ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomPoppinsText(
                        text:
                            "Well maintained car .All document complete . Great pick up . Good Engine . All original paint . Have a look ful insured. Family used car",
                        fontSize: 12,
                      ),
                      SizedBox(
                        height: 15,
                      ...
                      CustomPoppinsText(
                        text: "ADDITIONAL VEHICLE INFORMATION:",
                        fontSize: 13,
                      ),
                      ListView.builder(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                      ...
                      child: Text(
                        "REPORT AD",
                        style: TextStyle(fontSize: 15, color: orangeColor),
                      )),
                ],
              ),
            ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height:
                                      ResponsiveRatio().height(context, 0.13),
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image: AssetImage(
                                              "asset/images/c2.jpeg"),
                                          fit: BoxFit.cover),
            ...
            SizedBox(
              height: ResponsiveRatio().height(context, 0.1),
            ),
          ],
        ),
      ),

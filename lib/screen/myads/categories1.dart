...
import 'package:webapp_clone/screen/myads/viewcategories1.dart';
                      ...
                      Padding(
                        ...
                        child: ListTile(
                            onTap: (){
                              ...
                              if(index==0){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listcar,title: "Cars",)));
                              }
                              else if(index==1){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listproperties,title: "Properties",)));
                              }else if(index==2){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listproperties,title: "Mobiles",)));
                              }else if(index==3){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listproperties,title: "Jobs",)));
                              }else if(index==4){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listproperties,title: "Bike",)));
                              }else if(index==5){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listproperties,title: "Electronic & Appliaces",)));
                              }else if(index==6){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listcommercial,title: "Commercial Vehicles & Spares",)));
                              }else if(index==7){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewCategories1(myDataList: _listfurniture,title: "Furniture",)));
                              }
                              else {
                                return null;
                              }
                            ...
                            title: CustomPoppinsText(text: _list[index].title.toString(),fontSize: 13,),

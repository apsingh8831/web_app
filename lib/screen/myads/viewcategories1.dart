...
import '../Categories/categories/categories.item.dart';

class ViewCategories1 extends StatefulWidget {
  final List myDataList;
  final title;
  ViewCategories1({Key? key, required this.myDataList,this.title}) : super(key: key);

  @override
  State<ViewCategories1> createState() => _ViewCategories1State();
}

class _ViewCategories1State extends State<ViewCategories1> {
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context,index){
            return ListTile(
              ...
              title: CustomPoppinsText(text: widget.myDataList[index],fontSize: 15,)
